...
public class BitmapItem extends SlideItem {
	...
	public BitmapItem(int level, String name) {
		...
		if (!isValidImageExtension(imageName)) {
			throw new IllegalArgumentException("Invalid file type for FactoryMethodAndComposite.BitmapItem: " + imageName);
		}
	...
	public String toString() {
		return "FactoryMethodAndComposite.BitmapItem[" + getLevel() + "," + imageName + "]";
	}
}